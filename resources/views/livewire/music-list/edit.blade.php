...
#simp{font-size:14px;background:#17212b;color:#ddd;margin:0 auto;border-radius:6px;overflow:hidden;}
...
#simp .simp-time .simp-slash,#simp .simp-time .end-time{display:none;}
    ...
    <form wire:submit="save">
        ...
        <div class="simple-audio-player" id="simp" data-config='{"shide_top":true,"shide_btm":false,"auto_load":true}'>
